...
begin
  ...
  if (Transaction^.txFirst_Dissection = nil) then begin
    ...
    AddFieldNode(FTransactionNode, 'Narration', GetNarration(Transaction, Bank_Account.baFields.baAccount_Type));
    ...
    // Supper fields
    AddFieldNode(FTransactionNode, 'CGT_Transaction_Date', Date2Str(Transaction^.txSF_CGT_Date, 'dd/mm/YYYY'));
...
begin
  ...
  // Supper fields
  AddFieldNode(FTransactionNode, 'CGT_Transaction_Date', Date2Str(Dissection^.dsSF_CGT_Date, 'dd/mm/YYYY'));
  AddFieldNode(FTransactionNode, 'Franked_Dividend', FormatFloatForXml(Dissection^.dsSF_Franked));
  AddFieldNode(FTransactionNode, 'UnFranked_Dividend', FormatFloatForXml(Dissection^.dsSF_Unfranked));
  AddFieldNode(FTransactionNode, 'Imputation_Credit', FormatFloatForXml(Dissection^.dsSF_Imputed_Credit));
  AddFieldNode(FTransactionNode, 'Tax_Free_Distribution', FormatFloatForXml(Dissection^.dsSF_Tax_Free_Dist));
  AddFieldNode(FTransactionNode, 'Tax_Exempt_Distribution', FormatFloatForXml(Dissection^.dsSF_Tax_Exempt_Dist));
  AddFieldNode(FTransactionNode, 'Tax_Defered_Distribution', FormatFloatForXml(Dissection^.dsSF_Tax_Deferred_Dist));
  ...
  AddFieldNode(FTransactionNode, 'Foreign_Credit', FormatFloatForXml(Dissection^.dsSF_Foreign_Capital_Gains_Credit));
  AddFieldNode(FTransactionNode, 'Other_Expenses', FormatFloatForXml(Dissection^.dsSF_Other_Expenses));
  AddFieldNode(FTransactionNode, 'Indexed_Capital_Gain', FormatFloatForXml(Dissection^.dsSF_Capital_Gains_Indexed));
  AddFieldNode(FTransactionNode, 'Discount_Capital_Gain', FormatFloatForXml(Dissection^.dsSF_Capital_Gains_Disc));
  AddFieldNode(FTransactionNode, 'Other_Capital_Gain', FormatFloatForXml(Dissection^.dsSF_Capital_Gains_Other));
  if Dissection^.dsSF_Member_Component > 0 then
    AddFieldNode(FTransactionNode, 'Member_Component', IntToStr(Dissection^.dsSF_Member_Component));
