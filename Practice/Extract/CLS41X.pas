unit CLS41X;
{
   ...
   This is the extract data program for Solution 6 MAS 4.1 and is imported
   using Cheque List. Cheque List is not Y2K compliant and does not exist in
   MAS 4.2.
...
procedure CLS41Write( const ADate       : TStDate;
                      const AType       : Byte;
...
Begin
   ...
   Begin
      ...
      Begin
         ...
         CLS41Write( txDate_Effective,                {  const ADate       : TStDate;     }
...
Begin
   ...
   Msg := 'Extract data [CLS41 format] from '+BkDate2Str( FromDate ) + ' to ' + bkDate2Str( ToDate );
   ...
   begin
      ...
      Begin
         ...
         Try
            ...
            CLS41Write( ToDate,                 {const ADate       : TStDate;     }
