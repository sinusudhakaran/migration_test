...
{$ENDIF}
     ...
     InfoMoreFrm, BKDefs, glConst, baUtils;
...
procedure CSVWrite(  ABank        : ShortString;
 							ADate        : TStDate;
                     ARefce       : ShortString;
...
Begin
   ...
   write( XFile, '"', StStrS.TrimSpacesS(ReplaceCommasAndQuotes(ABank)), '",' );
...
Begin
   ...
   Begin
      ...
      Begin
         ...
         CSVWrite( 	StripM(Bank_Account),  { ABank        : ShortString      }
...
Begin
   ...
   Begin
      ...
      CSVWrite(   StripM(Bank_Account),                    { ABank        : ShortString      }
      			  txDate_Effective, 	                         { ADate        : TStDate;         }
                  getDsctReference(Dissection,Transaction,baAccount_Type ),{ ARefce       : ShortString;     }
...
Begin
   ...
   Msg := 'Extract data [EasyBooks format] from '+BkDate2Str( FromDate ) + ' to ' + bkDate2Str( ToDate );
