unit MYOBAOX;
{
   ...
   This is the extract data program for MYOB Accountants Office.  This is based
   on the CA Systems extract.

   MYOB only expects the I,O,E,Z indicator to be passed back to it, this means
   that we only need to pass the first character of the gst code back.
}
...
Begin
   ...
   Msg := 'Extract data [MYOBAO format] from '+BkDate2Str( FromDate ) + ' to ' + bkDate2Str( ToDate );
