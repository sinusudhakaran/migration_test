...

{
   ...
   This is the extract data program for the OLD version of Master 2000.
...
Begin
   ...
   Msg := 'Extract data [Old Master 2000 format] from '+BkDate2Str( FromDate ) + ' to ' + bkDate2Str( ToDate );
