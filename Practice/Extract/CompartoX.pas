...
(*
   ...
   Comparto Contact Details:

   Ph 0061 7 3870 8511
   John Guiton (Developer)

   This is CSV Format data.
...
Begin
   ...
   Msg := 'Extract data [Comparto format] from '+BkDate2Str( FromDate ) + ' to ' + bkDate2Str( ToDate );
   ...
   Try
      ...
      begin
         ...
         Writeln( XFile, '"Number","Date","Reference","Account","Amount","Quantity","Narration"' );
