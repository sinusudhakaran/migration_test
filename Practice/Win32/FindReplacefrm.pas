...
begin
  EFind.Text := LookUpChart(EFind.Text, HasChartBeenRefreshed, nil, true, true,
    [doShowInactive]);
end;
...
var
  HasChartBeenRefreshed : boolean;
begin
  EReplace.Text := LookUpChart(EReplace.Text, HasChartBeenRefreshed, nil, true,
    true, [doShowInactive]);
end;
      ...
      for T := 0 to ba.baTransaction_List.Last do begin
        ...
        begin
          ...
          begin
            ...
            SuggestedMem.SetSuggestedTransactionState(BA, TX, tssUnScanned, true);
