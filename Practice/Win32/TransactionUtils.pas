...
begin
  ...
  pT^.txSF_Fund_ID := 0;
  pT^.txSF_Member_Account_ID := 0;
  pT^.txSF_Fund_Code := 0;
  pT^.txSF_Member_Account_Code := 0;
  pT^.txSF_Transaction_ID := 0;
  pT^.txSF_Transaction_Code := 0;
  pT^.txSF_Capital_Gains_Fraction_Half := 0;
  ...
  pT^.txTransaction_Extension^.teSF_Share_GST_Rate := 0;
...
begin
  ...
  pd^.dsSF_Fund_ID := 0;
  pd^.dsSF_Member_Account_ID := 0;
  pd^.dsSF_Fund_Code := 0;
  pd^.dsSF_Member_Account_Code := 0;
  pd^.dsSF_Transaction_ID := 0;
  pd^.dsSF_Transaction_Code := 0;
  pd^.dsSF_Capital_Gains_Fraction_Half := 0;
  ...
  pd^.dsDissection_Extension^.deSF_Share_GST_Rate := 0;
