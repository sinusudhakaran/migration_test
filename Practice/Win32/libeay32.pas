...
function AES_set_encrypt_key(userKey: PCharacter; bits: integer; key: pAES_KEY): integer; cdecl;

procedure AES_decrypt(buffer: PCharacter; u: PCharacter; key: pAES_KEY); cdecl;
...
function SHA256_Update(c : pSHA256_CTX; data : pointer; size: integer): integer; cdecl;
function SHA256_Final(md : PChar; c : pSHA256_CTX): integer; cdecl;
function SHA256(d : PChar; n : integer; md : PChar) : PChar; cdecl;
procedure SHA256_Transform(c : pSHA256_CTX; data : Pchar); cdecl;
...
function AES_set_encrypt_key; external LIBEAY_DLL_NAME;

procedure AES_decrypt; external LIBEAY_DLL_NAME;
...
function SHA256_Init; external LIBEAY_DLL_NAME;
function SHA256_Update; external LIBEAY_DLL_NAME;
function SHA256_Final; external LIBEAY_DLL_NAME;
function SHA256; external LIBEAY_DLL_NAME;
procedure SHA256_Transform; external LIBEAY_DLL_NAME;
