    ...
    1:
      begin
        ...
        if xcHasFixedFilename[ExportType] then
          lblTitle.Caption := 'Please select the month to export and the folder to save to. The charges will be exported to the file banklink.csv in the selected folder.'
        else
    ...
    1:
      begin
        ...
        begin
          ...
          Begin
            HelpfulWarningMsg('You can''t use this filename because the .BK5 extension is used by BankLink.', 0);
            eTo.SetFocus;
            exit;
          end;
        ...
        begin
          HelpfulWarningMsg('You cannot save to the BK5 Work folder because it is reserved for use by BankLink.', 0);
          eTo.SetFocus;
          exit;
        end;
...
{        // strip GST 12.5% in NZ, 10% in AU
        ...
        sRowText := FormatDateTime('dd/mm/yyyy', Date) + #9 +
          ...
          '"Imported BankLink Charge, File Code=' + Cell[colFileCode, iRow] + ', Cost Code=' + Cell[colCostCode, iRow] + '"';
        exportFile.Add(sRowText);
        Inc(iRow);
      end;
