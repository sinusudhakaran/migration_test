...
begin
  ...
  try
    ...
    Eula.Clear;
    Eula.Add('Last updated: March 2014');
    Eula.Add('');
    Eula.Add('Software End-User Licence Agreement for Media Transfer Services Limited');
    ...
    Eula.Add('        	with MYOB BankLink (or its Licensors). You acknowledge that rights in');
    ...
    Eula.Add('        	including MYOB Australia Pty and MYOB NZ Limited) collects, discloses');
    Eula.Add('        	and uses your personal information to provide you with the');
    Eula.Add('        	Software and associated support, respond to your enquiries or');
    Eula.Add('        	feedback and to promote the Software and other products and services');
    Eula.Add('        	offered by MYOB BankLink and associated third parties. MYOB BankLink');
    Eula.Add('        	may collect personal information from you, from public sources');
    Eula.Add('        	such as social media websites, or from third parties that provide');
    Eula.Add('        	MYOB BankLink with marketing leads.');
    Eula.Add('');
    ...
    Eula.Add('        	(www.banklink.com.au/index.php/privacy).');
    Eula.Add('');
    ...
    Eula.Add('        	the details outlined below. The MYOB BankLink Privacy Policy for');
    Eula.Add('        	New Zealand is located at www.banklink.co.nz/index.php/privacy.');
    Eula.Add('');
    Eula.Add('        	You can contact MYOB BankLink about your privacy by email at');
    Eula.Add('        	privacy_officer@myob.co.nz, or by post at “Privacy Officer”');
    Eula.Add('        	MYOB BankLink, C/- Quigg Partners, Level 7, 28 Brandon Street,');
    ...
    Eula.Add('        	  	MYOB BankLink Privacy Policy and that they have accepted and');
