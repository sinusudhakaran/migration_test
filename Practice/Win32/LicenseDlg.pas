...
begin
  ...
  try
    ...
    AUEula.Add('');
    AUEula.Add('Software End-User Licence Agreement for Media Transfer Services Limited (‘MYOB BankLink’). ');
    AUEula.Add('');
    AUEula.Add('IMPORTANT NOTICE PLEASE READ CAREFULLY BEFORE INSTALLING OR USING THE SOFTWARE:');
    AUEula.Add('');
    ...
    AUEula.Add('');
    AUEula.Add('5.1	Except as otherwise agreed, MYOB BankLink is not obliged to support the');
    AUEula.Add('        	Software, whether by providing advice, training, error-correction,');
    ...
    AUEula.Add('');
    AUEula.Add('        	5.6.1	Any of the data provided by or on behalf of MYOB BankLink and ');
    AUEula.Add('		received by you for use with the Software will be accurate');
    ...
    AUEula.Add('        	MYOB BankLink under this Agreement or from any failure or omission on');
    AUEula.Add('        	the part of MYOB BankLink or otherwise.');
    AUEula.Add(' ');
    ...
    AUEula.Add('        	equity, under statute or otherwise. This limitation will apply');
    AUEula.Add('        	even if MYOB BankLink has been advised of the possibility of such');
    AUEula.Add('        	damages.');
    AUEula.Add('');
    AUEula.Add('6.3	Where the ACL applies (if you acquired this Software in Australia) applies,');
    AUEula.Add('        	then the liability of MYOB BankLink for any loss arising as a result of or in ');
    AUEula.Add('        	relation to the supply by MYOB BankLink of the Software, including any');
    AUEula.Add('        	economic or consequential loss which maybe sustained or incurred, shall be');
    AUEula.Add('        	limited to:');
    AUEula.Add('');
    ...
    AUEula.Add('');
    AUEula.Add('7.1	Without prejudice to any other rights, MYOB BankLink may terminate this');
    AUEula.Add('        	Agreement by written notice to you with immediate effect if you');
    ...
    AUEula.Add('        	transfer, transmit, display and analyse any electronic data,');
    AUEula.Add('        	information or material, including the menus you select, the');
    AUEula.Add('        	number of times each menu is selected and the number of client');
    AUEula.Add('        	files involved, which is sourced by or through Use of the');
    AUEula.Add('        	Software.');
    AUEula.Add('');
    ...
    AUEula.Add('        	https://my.myob.co.nz/Pages/Privacy.aspx, or for Australia at');
    AUEula.Add('        	https://my.myob.com.au/Pages/Privacy.aspx');
    AUEula.Add('');
...
begin
  ...
  try
    ...
    NZEula.Add('');
    NZEula.Add('Software End-User Licence Agreement for Media Transfer Services Limited (‘MYOB BankLink’)');
    NZEula.Add('');
    NZEula.Add('IMPORTANT NOTICE PLEASE READ CAREFULLY BEFORE INSTALLING OR USING THE SOFTWARE:');
    NZEula.Add('');
    NZEula.Add('');
    ...
    NZEula.Add('');
    NZEula.Add('5.1	Except as otherwise agreed, MYOB BankLink is not obliged to support the');
    NZEula.Add('        	Software, whether by providing advice, training, error-correction,');
    ...
    NZEula.Add('');
    NZEula.Add('        	5.6.1	Any of the data provided by or on behalf of MYOB BankLink and ');
    NZEula.Add('		received by you for use with the Software will be accurate');
    ...
    NZEula.Add('        	MYOB BankLink under this Agreement or from any failure or omission on');
    NZEula.Add('        	the part of MYOB BankLink or otherwise.');
    NZEula.Add(' ');
    ...
    NZEula.Add('        	equity, under statute or otherwise. This limitation will apply');
    NZEula.Add('        	even if MYOB BankLink has been advised of the possibility of such');
    NZEula.Add('        	damages.');
    NZEula.Add('');
    NZEula.Add('6.3	Where the ACL applies (if you acquired this Software in Australia) applies,');
    NZEula.Add('        	then the liability of MYOB BankLink for any loss arising as a result of or in ');
    NZEula.Add('        	relation to the supply by MYOB BankLink of the Software, including any');
    NZEula.Add('        	economic or consequential loss which maybe sustained or incurred, shall be');
    NZEula.Add('        	limited to:');
    NZEula.Add('');
    ...
    NZEula.Add('');
    NZEula.Add('7.1	Without prejudice to any other rights, MYOB BankLink may terminate this');
    NZEula.Add('        	Agreement by written notice to you with immediate effect if you');
    ...
    NZEula.Add('        	transfer, transmit, display and analyse any electronic data,');
    NZEula.Add('        	information or material, including the menus you select, the');
    NZEula.Add('        	number of times each menu is selected and the number of client');
    NZEula.Add('        	files involved, which is sourced by or through Use of the');
    NZEula.Add('        	Software.');
    NZEula.Add('');
    ...
    NZEula.Add('        	https://my.myob.co.nz/Pages/Privacy.aspx, or for Australia at');
    NZEula.Add('        	https://my.myob.com.au/Pages/Privacy.aspx');
    NZEula.Add('');
