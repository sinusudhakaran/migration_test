object DlgLicense: TDlgLicense
  ...
  object mmoBankstream: TMemo
    ...
    Lines.Strings = (
        ...
        'Software End-User Licence Agreement for MTS Global Limited and M' +
        'edia Transfer '
      'Services UK Limited'
      ''
      ...
      ''
        ...
        '          licenced to  Bankstream and may be sub-licensed by Ban' +
        'kstream.  Provided'
      ...
      ''
        ...
        '5.5     Bankstream is providing this Software to you "AS IS" and' +
        ' you acknowledge'
      ...
      '          remains with you.'
      '        '
      '5.6     Bankstream does not warrant that:'
      ''
      
        '          5.6.1     Any of the data provided by or on behalf of ' +
      ...
      ''
        ...
        '         5.6.2     The Software will operate without interruptio' +
        'n or errors; or'
      ''
      ...
      ''
        ...
        '                        in relation to the supply by Bankstream ' +
        'of the Software, including'
      
        '                        any economic or consequential loss which' +
        ' may be sustained or'
      
        '                        incurred, shall be limited to (at Bankst' +
        'ream'#39's option):'
      ''
      
        '                        (a)     The replacement of the Software ' +
      ...
      ''
        ...
        '                        (c)     The payment of the cost of repla' +
        'cing the Software or'
      
        '                                 acquiring equivalent Software; ' +
        'or'
      '                         '
      
        '                        (d)     The payment of the cost of havin' +
        'g the Software replaced.'
      '                '
