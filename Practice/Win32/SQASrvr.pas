        {*************************************************************************
        *
        * Copyright 2000 - 2003 Rational Software Corporation. All Rights Reserved.
        ...
        **************************************************************************}
        ...
        uses
          Windows, ComCtrls,
			{$IF Defined(VER140) or Defined(VER150) or Defined(VER170) or Defined(VER180) }
				Variants,
			{$IFEND}
          OleAuto,
          OLE2, TypInfo, DB, DBTables, OleCtrls, Grids, Controls, Registry;
        const
