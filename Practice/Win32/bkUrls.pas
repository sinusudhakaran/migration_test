...
begin
  Result := DefaultAUCatalogServer; //bkBranding.Rebrand(DefaultAUCatalogServer);
end;
...
begin
  Result := DefaultDownloaderURL; //bkBranding.Rebrand(DefaultDownloaderURL);
end;

class function TUrls.DefaultDownloaderURL2: String;
begin
  Result := DefaultDownloaderURL2; //bkBranding.Rebrand(DefaultDownloaderURL2);
end;

class function TUrls.DefaultNZCatalogServer: String;
begin
  Result := DefaultNZCatalogServer; //bkBranding.Rebrand(DefaultNZCatalogServer);
end;

class function TUrls.DefaultUKCatalogServer: String;
begin
  Result := DefaultUKCatalogServer; //bkBranding.Rebrand(DefaultUKCatalogServer);
end;
...
begin
  Result := whBankLinkWebSites[Index]; //bkBranding.Rebrand(whBankLinkWebSites[Index]);
end;
