    ...
    try
      ...
      begin
       ...
       HelpfulInfoMsg('Outlook cannot be accessed.' + #13#13 +
         ...
         ' then please select Yes. It is suggested that you allow 10 minutes access to allow ' + TProduct.BrandName +
  ...
  begin
    ...
    begin
      HelpfulErrorMsg('The column "' + CurrentClient[i] + '" is not a valid column name.' + #13#13 +
        'Please see ' + TProduct.BrandName + ' Help for information on the required import CSV fields.', 0);
      Result := False
    end
