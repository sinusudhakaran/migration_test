...
(*
  This is the same as the NZ version of Attache 5 and Attache Business Partner.
  The OZ version of Attache 5 used a different (CSV) format.
*)
