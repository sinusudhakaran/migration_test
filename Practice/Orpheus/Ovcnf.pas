...
var
  ...
  var
    ...
    function CountAfterDp : word;  //BankLink
    begin
      if tFound then
        result := strlen(nfTmp)-tDotPos
      else
        result :=0;
    end;
  ...
  begin
    ...
    if (Ch = '-') then begin
      ...
      {check if too many digits to right of decimal point - BankLink modification}
      if CountAfterDp > nfPlaces then exit;
