...
type
  ...
  TOvcTableColumn = class(TPersistent)
    protected {private}
      ...
      FWidth    : Integer;
      FColSortStatus : TColSortStatus; {BankLink modification}
    ...
    protected
      ...
      procedure SetSortStatus (SS : TColSortStatus); {BankLink modification}
    ...
    published
      ...
      property SortStatus : TColSortStatus  {BankLink modifications}
         read FColSortStatus write SetSortStatus
         default soNone;
  end;
...
{--------}
procedure TOvcTableColumn.SetSortStatus (SS: TColSortStatus);  {BankLink modification}
  begin
  if (SS <> SortStatus) then
     begin
        FColSortStatus := SS;
        tcDoColumnChanged;
     end;
