...
type
  TOvcBaseTableCell = class(TOvcTableCellAncestor)
    ...
    protected
      ...
      function tcRetrieveTableSortedCol : TColNum;   {BankLink modification}
...
function TOvcBaseTableCell.tcRetrieveTableSortedCol: TColNum;
 begin
   Result := 0;
   if Assigned(FTable) and FTable.HandleAllocated then
      Result := SendMessage(FTable.Handle, ctim_QuerySortedCol,0,0);
end;
{--------}
