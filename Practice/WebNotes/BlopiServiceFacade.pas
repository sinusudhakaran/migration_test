...
type
  ...
  ['{88E4B606-483E-CC24-1C42-418E3CD2E07E}']
    ...
    function  GetTermsConditionsVersion(const countryCode: WideString; const practiceCode: WideString; const passwordHash: WideString): MessageResponseOfstring; stdcall;
