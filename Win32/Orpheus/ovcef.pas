...
{!!.04}
  02/28/02 - RangeHi/RangeLo Bug Fixed.
*)
...
uses
  ...
  OvcIntl, OvcMisc, OvcStr, OvcUser, OvcDate, OvcBordr, Themes;
...
begin
  ...
  if (ValidateContents(true) > 0)                                     {!!.05}
  and (Parent <> nil)                                                 {!!.05}
  and (Parent.Visible)                                                {!!.05}
  and (Parent.Enabled) then                                           {!!.05}
    SetFocus;                                                         {!!.05}
end;
...
var
  WasValid : Boolean;
begin
{!!.05 - If the parent is not enabled or visible then don't attempt to }
