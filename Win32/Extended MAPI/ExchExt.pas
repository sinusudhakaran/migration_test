...
IExchExtCallback = interface(IUnknown)
  ...
  function GetSelectionItem( ieid : longint; var lpcbeid:longint;
                             ...
                             lpszMsgClass : PChar; cbMsgClass:longint;
  ...
  function GetSharedExtsDir(lpszDir :PChar; cchDir:longint; var ulFlags:longint):HResult;stdcall;
...
IExchExtCommands = interface(IUnknown)
  ...
  function QueryHelpText(cmdid : UINT; ulFlags : ULONG; lpsz :PChar; cch : UINT) : HRESULT;stdcall;
  function QueryButtonInfo(tbid : ULONG; itbb : UINT; ptbb : PTBButton;
                           lpsz : PChar; cch : UINT; ulFlags :ULONG) : HRESULT;stdcall;
