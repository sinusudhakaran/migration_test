                  ...
                  begin
                    ...
                    begin
                      ...
                      if (ControlType = 'PASSWORD') then
                        {$IFNDEF TMSDOTNET}
                        DrawText(Canvas.Handle,PChar(ConvertToPassword(ControlValue)),Length(ControlValue),ir,DT_LEFT)
                        {$ENDIF}
                        {$IFDEF TMSDOTNET}
                        DrawText(Canvas.Handle,ConvertToPassword(ControlValue),Length(ControlValue),ir,DT_LEFT)
                        {$ENDIF}
                      else
                        {$IFNDEF TMSDOTNET}
