...
type
  ...
  public
    ...
    constructor Create(const aStrLenLength: TStrLenLength;const s: wideString; const ForceWide: boolean= false); overload;
...
constructor TExcelString.Create(const aStrLenLength: TStrLenLength;
  const s: wideString; const ForceWide: boolean);
begin
  inherited Create;
  StrLenLength:=aStrLenLength;
