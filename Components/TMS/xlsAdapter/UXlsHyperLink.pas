...
type
  ...
  private
    ...
    function ReadString(var Pos: Integer; const OptMask: Integer; const ByteSize: Integer): widestring;
    function ReadLocalFile(var Pos: Integer): widestring;
    procedure SetString(var Pos: Integer; const OptMask: Integer; const value: widestring);
    procedure SetString2(var Pos: Integer; const GUID: PArrayOfByte; const value: widestring; const ByteCount: Integer);
    procedure SetLocalFile(var Pos: Integer; const value: widestring);
    function IsUrl(pos: Integer): Boolean;
    function IsFile(pos: Integer): Boolean;
    function IsUNC(pos: Integer): Boolean;
    function GetText(var pos: Integer; var HType: THyperLinkType): widestring;
    procedure SetText(var pos: Integer; Text: widestring; HType: THyperLinkType);
    procedure ClearData;
  ...
  public
    constructor Create(const aId: word; const aData: PArrayOfByte; const aDataSize: integer);  override;
    constructor CreateNew(aDescription: widestring);
  ...
  public
    ...
    procedure SaveToStream(DataStream: TStream);
    procedure SaveRangeToStream(DataStream: TStream; CellRange: TXlsCellRange);
...
function THLinkRecord.ReadString(var Pos: Integer; const OptMask: Integer; const ByteSize: Integer): widestring;
var
  OldPos: Integer;
begin
  ...
  begin
    ...
    SetLength(Result, (Pos-(OldPos+4)-2) div 2);
    move(Data[OldPos+4], Result[1], Length(Result)*2);
  end;
end;

function THLinkRecord.ReadLocalFile(var Pos: Integer): widestring;
var
  XLen: Integer;
  RLen: Integer;
  s8: string;
...
procedure THLinkRecord.SetString(var Pos: Integer; const OptMask: Integer; const value: widestring);
var
  Len: Integer;
begin
  if (value= '') then
...
procedure THLinkRecord.SetString2(var Pos: Integer; const GUID: PArrayOfByte; const value: widestring; const ByteCount: Integer);
var
  GuidSize: integer;
begin
...
procedure THLinkRecord.SetLocalFile(var Pos: Integer; const value: widestring);
var
  WideDataLen: Integer;
...
begin
  if ((((OptionFlags and 3) = $03) and ((OptionFlags and $60) = 0)) and
    ...
    begin
      Result := CompareMem(@URLGUID, PCHAR(Data)+ pos,16);
      Exit;
    end;
  Result := False;
end;
...
begin
  if ((((Self.OptionFlags and 1) = $01) and ((Self.OptionFlags and $60) = 0)) and
    ((Self.OptionFlags and $100) = 0)) then
    begin
      Result := CompareMem(@FILEGUID, PCHAR(Data)+ pos,16);
      Exit;
    end;
  Result := False;
end;
...
function THLinkRecord.GetText(var pos: Integer; var HType: THyperLinkType): widestring;
begin
  if IsUrl(pos) then
  begin
    HType := hl_URL;
...
procedure THLinkRecord.SetText(var pos: Integer; Text: widestring; HType: THyperLinkType);
begin
  case (HType) of
    hl_URL:
    begin
...
constructor TScreenTipRecord.CreateNew(aDescription: widestring);
begin
...
function TScreenTipRecord.GetText: widestring;
begin
...
procedure TScreenTipRecord.SetText(Value: widestring);
begin
  FreeAndNil(Data);
...
procedure THLinkList.SaveToStream(DataStream: TStream);
var
  i: Integer;
begin
  Sort;
...
procedure THLinkList.SaveRangeToStream(DataStream: TStream; CellRange: TXlsCellRange);
var
  i: Integer;
begin
  Sort;
