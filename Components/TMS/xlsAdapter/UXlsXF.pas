...
uses Classes, SysUtils, UXlsBaseRecords, UXlsBaseRecordLists, XlsMessages,
     UFlxFormats, UXlsStrings, UFlxMessages;
...
type
  ...
  public
    function FindFormat(const XF: TXFRecord; var Index: integer): boolean;
...
/////////////////////////////////////////////////// FORMAT
  ...
  public
    ...
    constructor CreateFromData(const Fmt: Widestring; const NewID: integer);
  end;

  TFormatRecordList=class(TBaseRecordList)
  private
    function GetFormat(FormatId: integer): Widestring;  //Items are TFormatRecord
  {$INCLUDE TFormatRecordListHdr.inc}
  public
    property Format[index: integer]: Widestring read GetFormat; default;
    function AddFormat(const Fmt: WideString): integer;
  end;
implementation
...
const
  XlsBuiltInFormatsUs: array[0..49] of widestring=
  ('', '0', '0.00','#,##0','#,##0.00',                              //0..4
...
function XlsBuiltInFormats(const z: integer): string;
var
  i: integer;
  s, Sep, Hour: string;
  c: char;
