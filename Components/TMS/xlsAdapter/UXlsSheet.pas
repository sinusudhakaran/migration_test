...
uses Classes, SysUtils, UXlsBaseRecords, UXlsBaseRecordLists, UXlsOtherRecords, UXlsChart,
     ...
     UFlxMessages, UXlsCellRecords, UXlsFormula, UXlsPageBreaks,
...
type
  ...
  public
    ...
    procedure GetFrozenPanes(var row, col: integer);
    procedure GetSplitWindow(var xOffset, yOffset: integer);
    procedure SplitWindow(const xOffset, yOffset: integer);

    property CodeName: widestring read GetCodeName write SetCodeName;
