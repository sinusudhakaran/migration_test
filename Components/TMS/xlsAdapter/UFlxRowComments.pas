...
type
  ...
  private
    ...
    function Find(const aRow: integer; var Index: integer): boolean;
  public
    constructor Create;
...
var
  i: integer;
begin
  if not Find(aRow, i) then begin;Insert( i, TCommentRowPos.Create); (inherited Items[i] as TCommentRowPos).Row:=aRow;end;
...
function TRowComments.Find(const aRow: integer ; var Index: integer): boolean;
Var
 L, H, I, C: Integer;
begin
  Result := False;
