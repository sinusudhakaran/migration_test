...
uses SysUtils, XlsMessages, UXlsBaseRecords,
     UXlsOtherRecords, UXlsStrings, Classes, UFlxMessages;
type
  ...
  PiSSTEntry   = PArrayOfByte;  //Pointer to intenal calcs. Never store it, because MemData.Buffer can be realocated
  ...
  public
    ...
    function AddString(const s:Widestring; const RTFRuns: TRTFRunList):integer;
    procedure Sort;
  ...
  private
    ...
    function GetAsRTF: WideString;
    procedure SetAsRTF(const Value: WideString);
  ...
  public
    ...
    property AsRTF: WideString read GetAsRTF write SetAsRTF;
  end;
...
procedure AddContinue (const DataStream: TStream; var Buffer: TRecordBuff; var BufferPos: integer; var BeginRecordPos: LongWord; var TotalSize: int64);
begin
...
procedure WriteArray(const DataToWrite: PArrayOfByte; const DataLength: integer; DataStream: TStream; var Buffer: TRecordBuff;
...
procedure SaveSSTToStream(const Entry: PiSSTEntry; const DataStream: TStream;
