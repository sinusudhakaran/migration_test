...
function GetString(const Length16Bit: boolean; const RPN: PArrayOfByte; const tpos: integer; var sl: integer): widestring;
begin
  GetSimpleString(Length16Bit, RPN, tpos, false, 0, Result, sl);
  Result:=StringReplace(Result,'"','""',  [rfReplaceAll]);
end;

function GetErrorText(const Err: byte): widestring;
begin
  case Err of
...
function GetBoolText(const Bool: byte): widestring;
begin
...
function ReadCachedValueTxt(const RPN:PArrayOfByte; var ArrayPos: integer):widestring;
var
  ValueType: byte;
  sl: integer;
begin
...
function GetArrayText(const RPN: PArrayOfByte; const tpos: integer; var ArrayPos: integer):widestring;
var
  Columns: integer;
  Rows: integer;
  r,c:integer;
...
function Get1Ref(const Row, Col: integer): widestring;
begin
...
function GetRef(const RPN: PArrayOfByte; const tpos: integer):widestring;
var
  Row, Col: integer;
begin
...
function GetRowRange(const Row1, Row2: integer; const Abs1, Abs2: boolean): widestring;
begin
...
function GetColRange(const Col1, Col2: integer): widestring;
begin
...
function GetArea(const RPN: PArrayOfByte; const tpos: integer):widestring;
var
...
function GetRef3D(const RPN: PArrayOfByte; const tpos: integer; const CellList: TCellList):widestring;
var
  Idx: integer;
  Row, Col: integer;
begin
...
function GetArea3D(const RPN: PArrayOfByte; const tpos: integer; const CellList: TCellList):widestring;
var
  Idx: integer;
  Row1, Col1, Row2, Col2: integer;
begin
...
function GetFuncName(const RPN: PArrayOfByte; const tPos: integer; var minnp, maxnp: integer): widestring;
var
  index: integer;
begin
