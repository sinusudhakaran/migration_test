...
begin
  ...
  begin
    ...
    begin
      ...
      //ACanvas.Rectangle(r);
      {$IFNDEF TMSDOTNET}
      DrawText(ACanvas.Handle, PChar(FCaption.Text), Length(FCaption.Text), R, DT_SINGLELINE or DT_BOTTOM or DT_LEFT{ or DT_END_ELLIPSIS})
      {$ENDIF}
      {$IFDEF TMSDOTNET}
      DrawText(ACanvas.Handle, FCaption.Text, Length(FCaption.Text), R, DT_SINGLELINE or DT_BOTTOM or DT_LEFT{ or DT_END_ELLIPSIS})
      {$ENDIF}
  ...
  begin
    ...
    begin
      ...
      if not Collaps and FCanSize then
        ACanvas.TextOut(R2.Left + 2, R2.Bottom -16, FStatusBar.Text)
      else
        ACanvas.TextOut(R2.Left + 2, R2.Bottom -2, FStatusBar.Text);
