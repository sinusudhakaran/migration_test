...
uses
  ...
  {$IFDEF TMSDOTNET}
  , System.Runtime.InteropServices, System.Text, uxTheme, Types
  {$ENDIF}
  ;
...
type
  ...
  public
    ...
    {$IFDEF TMSDOTNET}
    procedure ButtonPressed(Group: Integer; Button: TAdvToolButton);
    {$ENDIF}
...
uses
  ActnList, SysUtils, ImgList, ComObj;
...
{$IFDEF TMSDOTNET}
procedure TAdvToolButton.ButtonPressed(Group: Integer; Button: TAdvToolButton);
begin
