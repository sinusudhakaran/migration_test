...
begin
  ...
  begin
    if ((Component as TAdvGlowButton).Parent is TAdvQuickAccessToolBar) then
    begin
      ATB := TAdvGlowButton(Component).Parent;
      ...
      0:
        begin
          ...
          else if (TAdvGlowButton(Component).Parent is TAdvQuickAccessToolBar) then
          begin
            ATBButton.Width := 22;
            ATBButton.Height := 20;
            ATBButton.Left := 1000;
    ...
    else if not ((Component as TAdvGlowButton).Parent is TAdvToolBar) then
    begin
      case Index of
      0:
        begin
          with (Component as TAdvGlowButton).Appearance do
          begin
            Color := clWhite;
            ColorTo := clWhite;
      ...
      (Component as TAdvGlowButton).Repaint;
      Exit;
    end;
  end;
