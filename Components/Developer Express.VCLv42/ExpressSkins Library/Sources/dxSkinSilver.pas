...
type
  { TdxSilverPainter }
  TdxSilverPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
const
  SkinsCount = 1;
  SkinNames: array[0..SkinsCount - 1] of string = ('Silver');
...
class function TdxSilverPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxSilverPainter.InternalUnitName: string;
begin
  Result := 'dxSkinSilver';
end;
