...
type
  { TdxBlackPainter }
  TdxBlackPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
const
  SkinsCount = 1;
  SkinNames: array[0..SkinsCount - 1] of string = ('Black');
...
class function TdxBlackPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxBlackPainter.InternalUnitName: string;
begin
  Result := 'dxSkinBlack';
end;
