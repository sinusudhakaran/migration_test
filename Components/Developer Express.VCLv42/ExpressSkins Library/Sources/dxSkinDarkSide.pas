...
type
  { TdxDarkSidePainter }
  TdxDarkSidePainter = class(TdxSkinLookAndFeelPainter)
  protected
...
class function TdxDarkSidePainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxDarkSidePainter.InternalUnitName: string;
begin
  Result := 'dxSkinDarkSide';
end;
