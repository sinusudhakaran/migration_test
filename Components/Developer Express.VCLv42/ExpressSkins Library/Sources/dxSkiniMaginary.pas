...
type
  { TdxiMaginaryPainter }
  TdxiMaginaryPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
class function TdxiMaginaryPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxiMaginaryPainter.InternalUnitName: string;
begin
  Result := 'dxSkiniMaginary';
end;
