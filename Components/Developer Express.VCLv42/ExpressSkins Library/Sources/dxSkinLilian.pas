...
type
  { TdxLilianPainter }
  TdxLilianPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
const
  SkinsCount = 1;
  SkinNames: array[0..SkinsCount - 1] of string = ('Lilian');
...
class function TdxLilianPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxLilianPainter.InternalUnitName: string;
begin
  Result := 'dxSkinLilian';
end;
