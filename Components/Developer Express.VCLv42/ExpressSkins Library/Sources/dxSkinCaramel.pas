...
type
  { TdxCaramelPainter }
  TdxCaramelPainter = class(TdxSkinLookAndFeelPainter)
  protected
...
const
  SkinsCount = 1;
  SkinNames: array[0..SkinsCount - 1] of string = ('Caramel');
...
class function TdxCaramelPainter.CacheData: TdxSkinLookAndFeelPainterInfo;
begin
  Result := CachedPainterData[0];
end;

class function TdxCaramelPainter.InternalUnitName: string;
begin
  Result := 'dxSkinCaramel';
end;
