object fmOsGridEditor: TfmOsGridEditor
      ...
      object gbCombo: TGroupBox
        ...
        object Panel6: TPanel
          ...
          object chAutoFill: TCheckBox
            ...
            Height = 17
            Hint = 
              'Specifies if the combo'#39's edit box is automatically filled in wit' +
              'h the nearest match as you type'
            Caption = 'AutoFill'
            TabOrder = 9
          ...
          object cbConvertCase: TComboBox
            ...
            Height = 21
            Hint = 
              'Used in conjunction with AutoFill to indicate how selected value' +
              's are converted when selected'
            Style = csDropDownList
            ItemHeight = 13
            TabOrder = 12
          ...
          object cbCompareType: TComboBox
            ...
            Width = 129
            Height = 21
            Hint = 'Indicates how dropdown values are compared'
            Style = csDropDownList
            ItemHeight = 13
            TabOrder = 13
          ...
          object cbAutoSearch: TComboBox
            ...
            Height = 21
            Hint = 
              'Enables or Disables positioning of the selected row within the d' +
              'ropdown'
            Style = csDropDownList
            ItemHeight = 13
            TabOrder = 14
          ...
          object cbDropDownStyle: TComboBox
            ...
            Height = 21
            Hint = 
              'Enables or Disables cell editing (ie. forces use of dropdown if ' +
              'style = DropDownList)'
            Style = csDropDownList
            ItemHeight = 13
            TabOrder = 15
          ...
          object chComboStoreData: TCheckBox
            ...
            Width = 77
            Height = 17
            Hint = 'Allows direct entry of combo values below'
            Caption = 'Store Data'
            TabOrder = 11
          ...
          object chParentCombo: TCheckBox
            ...
            Height = 17
            Hint = 
              'Combo is defined at runtime at grid level (combo is shared betwe' +
              'en columns)'
            Caption = 'ParentCombo'
            TabOrder = 0
  ...
  object pmOptions: TPopupMenu
    ...
    object miInsertColumn: TMenuItem
      Caption = 'Insert Column'
      OnClick = miInsertColumnClick
    end
  ...
  object pmReset: TPopupMenu
    ...
    object miShowInvisibleColumns: TMenuItem
      Caption = 'Show &Invisible Columns'
      OnClick = miShowInvisibleColumnsClick
    end
    object N4: TMenuItem
      Caption = '-'
    end
