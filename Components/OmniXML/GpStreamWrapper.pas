{ $OmniXML: OmniXML/GpStreamWrapper.pas,v 1.2 2004/11/23 22:11:59 mr Exp $ }
...
{$IFDEF VER140}{$DEFINE D3PLUS}{$DEFINE D4PLUS}{$ENDIF}
{$IFDEF VER150}{$DEFINE D3PLUS}{$DEFINE D4PLUS}{$DEFINE D7PLUS}{$ENDIF}
{$IFDEF VER170}{$DEFINE D3PLUS}{$DEFINE D4PLUS}{$DEFINE D6PLUS}{$DEFINE D7PLUS}{$DEFINE D2005PLUS}{$ENDIF}
