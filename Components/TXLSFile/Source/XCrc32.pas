...
function BloCrc32(const StartCrc: longword; Count: Integer; Buf: PAnsiChar): longword;

implementation
const CrcBTabl: array[0..1023] of byte = (
    0,  0,  0,  0,$96,$30,$07,$77,$2C,$61,$0E,$EE,$BA,$51,$09,$99,
...
var CrcTabl: array[0..255] of longword absolute CrcBTabl;
...
begin
  ...
  for I:= 1 to Count do
  begin
    Result:= (Result shr 8) xor CrcTabl[Lo(Result) xor Byte(C^)];
    Inc(C);
  end;
end;
