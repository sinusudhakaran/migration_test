...
var
  ...
  begin
    ...
    begin
      SmallImages.Draw( HeaderCanvas, ARect.Left, ARect.Top, Columns[ Index ].ImageIndex );
  ...
  try
    case Msg.Msg of
      ...
      begin
        ...
        {$IFDEF VCL100_OR_HIGHER}
        if ThemeServices.ThemesEnabled and not FMouseInNonClient then
        begin
    ...
    Msg.Result := CallWindowProc( FDefHeaderProc, HeaderHandle,
