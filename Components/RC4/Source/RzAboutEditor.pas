...
resourcestring
  sCopyrightDate = '1995-2007';
  sCompanyName = 'Raize Software, Inc.';
  sProductVersion  = 'Version ' + RaizeComponents_Version;
  {$IFDEF RAIZETRIAL}
  sProductName = 'Raize Components ' + RaizeComponents_Version + ' - Trial Edition';
  {$ELSE}
  sProductName = 'Raize Components ' + RaizeComponents_Version;
  {$ENDIF}
...
begin
  ...
  lblCopyright.Caption := 'Copyright © '+ SCopyrightDate + ' ' + SCompanyName + ' All Rights Reserved.';
