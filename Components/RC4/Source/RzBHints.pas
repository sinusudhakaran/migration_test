...
begin
  ...
  begin
    ...
    {$ELSE}
    WorkArea := Classes.Rect( 0, 0, Screen.Width, Screen.Height );
    {$ENDIF}   
  end;
  ...
  {$ELSE}
  FHintRect := Classes.Rect( TopLeft.X, TopLeft.Y, TopLeft.X + W, TopLeft.Y + H );
  {$ENDIF}
...
begin
  ...
  DrawText( Canvas.Handle, PChar( Caption ), -1, Bounds,
