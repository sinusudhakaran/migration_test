...
begin
  ...
  P1 := PChar( PPidlItem( Item1 ).PIDL );
  P2 := PChar( PPidlItem( Item2 ).PIDL );
...
const
  ...
  _IID_IShellLink: TGUID = ( D1: $000214EE; D2: $0000; D3: $0000; D4: ( $C0, $00, $00, $00, $00, $00, $00, $46 ) );
...
begin
  ...
  begin
    ...
    else if Str[ CurPos ] in WHITESPACE_SET then
    begin
