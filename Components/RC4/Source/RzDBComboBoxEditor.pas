...
function TRzDBComboBoxEditor.MenuBitmapResourceName( Index: Integer ): string;
begin
  ...
  case Index of
    ...
    4: Result := 'RZDESIGNEDITORS_EDIT_ITEMS';
  end;
end;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          {$ELSE}
          grdItemsValues.Cells[ 2, I + 1 ] := FileContents.Values[ FileContents.Names[ I ] ];
          {$ENDIF}
        end
        else
