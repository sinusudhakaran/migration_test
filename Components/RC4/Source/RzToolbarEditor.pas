...
function TRzToolbarEditor.MenuBitmapResourceName( Index: Integer ): string;
begin
  case Index of
    0: Result := 'RZDESIGNEDITORS_EDIT_TOOLBAR';
    1: Result := 'RZDESIGNEDITORS_TOOLBAR_ADD_BUTTON';
    2: Result := 'RZDESIGNEDITORS_TOOLBAR_ADD_SPACER';
    4: Result := 'RZDESIGNEDITORS_IMAGELIST';
    9:
    begin
      if Toolbar.ShowDivider then
        Result := 'RZDESIGNEDITORS_DIVIDER_HIDE'
      else
        Result := 'RZDESIGNEDITORS_DIVIDER_SHOW';
    end;
    11: Result := 'RZDESIGNEDITORS_REGINIFILE';
  end;
end;
...
procedure TRzToolbarEditor.PrepareMenuItem( Index: Integer; const Item: TMenuItem );
  ...
  begin
    ...
    case Layout of
      0: NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_TOOLBAR_STYLE_NOCAPTIONS' );
      1: NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_TOOLBAR_STYLE_CAPTIONSBOTTOM' );
      2: NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_TOOLBAR_STYLE_CAPTIONSRIGHT' );
    end;
  ...
  begin
    ...
    case Settings of
      0: NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_TOOLBAR_CONTAINER' );
      1: NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_TOOLBAR_NESTED' );
    end;
