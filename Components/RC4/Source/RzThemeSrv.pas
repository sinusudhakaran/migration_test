{===============================================================================
  ...
  This unit contains Mike Lischke's ThemeServices class and supporting code.
  This unit is required for XP visual style support in versions 5 and 6 of the
  VCL.
  ...
  ------------------------------------------------------------------------------
  4.0.2  (13 Jan 2006)
    * Fixed issue that caused the "Unit RzThemeSrv was compiled with a different
      version of System.RTLVersion" message form appearing when compiling under
      Delphi 6 if RTL Update #3 was not applied.
  ------------------------------------------------------------------------------
  3.0.6  (11 Apr 2003)
    * Incorporated changes from 1.9.17 release of Mike Lischke's ThemeServices.
  ------------------------------------------------------------------------------
  3.0    (20 Dec 2002)
    * Initial release.
===============================================================================}
