{===============================================================================
  ...
  This unit contains the Delphi interface for the UxTheme.h header file. This
  unit is required for XP visual style support in versions 5 and 6 of the VCL.
...
type
  ...
  // Raize: Commented the following type out b/c there are no references to 
  // them in RC code, and exported symbol in HPP file causes conflicts
