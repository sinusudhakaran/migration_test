...
function TRzGroupBarEditor.MenuBitmapResourceName( Index: Integer ): string;
begin
  case Index of
    0: Result := 'RZDESIGNEDITORS_GROUPBAR_ADDGROUP';

    2:
    begin
      case GroupBar.Style of
        gbsCategoryView: Result := 'RZDESIGNEDITORS_GROUPBAR_CATEGORYVIEW';
        gbsTaskList:     Result := 'RZDESIGNEDITORS_GROUPBAR_TASKLIST';
        gbsOutlook:      Result := 'RZDESIGNEDITORS_GROUPBAR_OUTLOOK';
      end;
    end;
...
procedure TRzGroupBarEditor.PrepareMenuItem( Index: Integer; const Item: TMenuItem );
  ...
  begin
    ...
    case Style of
      gbsCategoryView: NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_GROUPBAR_CATEGORYVIEW' );
      gbsTaskList:     NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_GROUPBAR_TASKLIST' );
      gbsOutlook:      NewItem.Bitmap.LoadFromResourceName( HInstance, 'RZDESIGNEDITORS_GROUPBAR_OUTLOOK' );
    end;
...
function TRzGroupEditor.MenuBitmapResourceName( Index: Integer ): string;
begin
  case Index of
    0: Result := 'RZDESIGNEDITORS_ADD';
    3: Result := 'RZDESIGNEDITORS_EDIT';
    9: Result := 'RZDESIGNEDITORS_IMAGELIST';
    10: Result := 'RZDESIGNEDITORS_IMAGELIST';
    12: Result := 'RZDESIGNEDITORS_GROUPBAR_ADDGROUP';

    13:
    begin
      case Group.GroupBar.Style of
        gbsCategoryView: Result := 'RZDESIGNEDITORS_GROUPBAR_CATEGORYVIEW';
        gbsTaskList:     Result := 'RZDESIGNEDITORS_GROUPBAR_TASKLIST';
        gbsOutlook:      Result := 'RZDESIGNEDITORS_GROUPBAR_OUTLOOK';
      end;
...
function TRzGroupControllerEditor.MenuBitmapResourceName( Index: Integer ): string;
begin
  case Index of
    0: Result := 'RZDESIGNEDITORS_GROUPBAR_CATEGORYVIEW';
    1: Result := 'RZDESIGNEDITORS_GROUPBAR_TASKLIST';
    2: Result := 'RZDESIGNEDITORS_GROUPBAR_OUTLOOK';
    4: Result := 'RZDESIGNEDITORS_REGINIFILE';
  end;
end;
...
function TRzGroupTemplateEditor.MenuBitmapResourceName( Index: Integer ): string;
begin
  case Index of
    0: Result := 'RZDESIGNEDITORS_EDIT';
    1: Result := 'RZDESIGNEDITORS_GROUPBAR_CATEGORYVIEW';
    8: Result := 'RZDESIGNEDITORS_IMAGELIST';
    9: Result := 'RZDESIGNEDITORS_IMAGELIST';
  end;
end;
