...
type
  TBKDBDateTimeEdit = class(TRzDBDateTimeEdit)
  private
...
procedure Register;
begin
  RegisterComponents('BankLink', [TBKDBDateTimeEdit]);
end;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        {If neither were days then the first is days and the second is months}
        if VDay = 0 then
        begin
          VDay := CmpValues[0];
          VMonth := CmpValues[1];
...
constructor TBKDBDateTimeEdit.Create(aOwner: TComponent);
begin
  inherited;
...
procedure TBKDBDateTimeEdit.Change;
begin
  inherited;
end;

procedure TBKDBDateTimeEdit.DoDateEvaluation;
var
  SFormat: String;
  InText: String;
begin
...
procedure TBKDBDateTimeEdit.DisplayCalendar;
begin
  FGoingCalendar := True;
  try
    DoDateEvaluation;
...
procedure TBKDBDateTimeEdit.WMKillFocus(var Msg: TMessage);
begin
