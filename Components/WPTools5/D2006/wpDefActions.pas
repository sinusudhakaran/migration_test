...
uses
  SysUtils, Windows, Classes, Menus, Forms, WPCtrRich, Dialogs,
  ...
  WPUtil, WPSymDlg, WPAction, ActnList, ImgList, Controls, wpManHeadFoot
{$IFDEF WPREPORTER}
  , WPRTEReport, WPRepED
{$ENDIF}
{$IFDEF WPPREMIUM}
