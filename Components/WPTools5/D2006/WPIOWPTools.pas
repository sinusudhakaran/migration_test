...
{$DEFINE SAVE_ALL_NUMSTYLES_WPT} // if defined ALL number styles are saved
...
begin
  ...
  if paprNewPage in par.prop then mode := mode or 64;
...
function TWPTOOLSWriter.WriteChar(aChar: WideChar): Boolean;
begin
  Result := WriteHTMLChar(aChar);
end;
...
class function TWPTOOLSReader.UseForContents(const First500Char: string): Boolean;
begin
...
var s, Entity: string;
  ch, ch2, i, j, mode, section, aa: Integer;
          ...
          begin
            ...
            begin
              if (FCurrentParagraph = nil) or not FCurrentParagraph.Empty([], false) then
                NewParagraph;
              if (aTag.ParamValue('pagebreak', 1) = 1) and
                  ...
                  if aTag.NameEqual('hy') then
                    ...
                    begin
                      ...
                      begin
                        ...
                        if aTag.NameEqual('pstyle') and not OptOnlyBody then
                        begin
                          i := aTag.ParamValue('nr', 0);
                          ...
                          begin
                            ...
                            begin
                              ...
                              try
                                ...
                                PrintAChar(Char(aTag.ParamValue('ch', Integer(TextObjCode))));
...
{$ENDIF}
            ...
            begin
              ...
              try
                ...
                PrintAChar(Char(aTag.ParamValue('anchor', Integer(TextObjCode))));
                FCurrentParagraph.ObjectIndex[FCurrentParagraph.CharCount - 1] :=
            ...
            begin
              ...
              if (mode and 64) <> 0 then include(FCurrentParagraph.prop, paprNewPage);
