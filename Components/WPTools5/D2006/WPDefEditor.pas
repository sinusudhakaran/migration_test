...
uses
  ...
  Dialogs, Menus, ComCtrls, WPCTRRich, wpDefActions, ExtCtrls, WPRuler,
  WPRTEDefs, WPCTRMemo, Buttons, WPTbar, WPPanel, WPStyles, WP1Style, StdCtrls, WPRTEPaint, wpgutter

{$IFDEF WPREPORTER}
  , WPRTEReport, WPAction
{$ENDIF};
