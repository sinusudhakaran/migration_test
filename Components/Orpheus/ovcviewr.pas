...
type
  ...
  published
    ...
    property Caret;
    property Controller;
    property ExpandTabs default True;                                 {!!.05}
    property FileName;
    property FixedFont;
    ...
    property ShowCaret default True;                                  {!!.05}
...
type
  ...
  published
    ...
    property Borders;                                                         
    property BorderStyle default bsSingle;                            {!!.05}
    property BufferPageCount default 16;                              {!!.05}
    property Caret;
    property Controller;
    property ExpandTabs default True;                                 {!!.05}
    property FileName;
    property FilterChars default True;                                {!!.05}
    property FixedFont;
    property InHexMode default False;                                 {!!.05}
    property HighlightColors;
    property IsOpen default False;                                    {!!.05}
    property LabelInfo;
    property MarginColor default clWindow;                            {!!.05}
