...
uses
  ...
  Forms; {!!.05 for bsNone definition}
...
type
  ...
  published
    property AutoUpdate : Boolean
      read FAutoUpdate
      write FAutoUpdate default False;                                {!!.05}
    ...
    property About;
    property Align;
    property BorderStyle default bsNone;                              {!!.05}
    property Colors;
    property Color;                                                   {!!.04}
    property Ctl3D;
    property Cursor;
    property DateFormat default dfLong;                               {!!.05}
    property DayNameWidth default 3;                                  {!!.05}
    property DragCursor;
    property DragMode;
    property Enabled;
    property Font;
    property LabelInfo;
    property Options default [cdoShortNames, cdoShowYear, cdoShowInactive, cdoShowRevert, cdoShowToday, cdoShowNavBtns]; {!!.05}
    ...
    property Visible;
    property WeekStarts default dtSunday;                             {!!.05}
