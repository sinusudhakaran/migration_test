...
(*Changes)
{!!.02}
  01/16/02 - Added DBExpress TimeStamp field support to the DbPictureField.
*)
...
type
  ...
  published
    ...
    property FieldType : TFieldType
      read FFieldType
      write SetFieldType default ftUnknown;                           {!!.05}

    {load after FieldType}
    property DateOrTime : TDateOrTime
      read FDateOrTime
      write SetDateOrTime default ftUseDate;                          {!!.05}

    property UseTFieldMask : Boolean
      read FUseTFieldMask
      write SetUseTFieldMask default False;                           {!!.05}

    property ZeroAsNull : Boolean
      read FZeroAsNull
      write SetZeroAsNull default False;                              {!!.05}
