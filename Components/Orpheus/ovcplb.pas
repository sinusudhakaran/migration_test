...
{!!.02 - Hdc changed to TOvcHdc for BCB Compatibility }
  ...
  published
    ...
    {$ENDIF}
    property Align;
    property Alignment default taLeftJustify;                         {!!.05}
    property AutoSize;
    property Caption;
    property Color;
    property DragCursor;
    ...
    property Enabled;
    property Font;
    property FontAngle default 0;                                     {!!.05}
    property OriginX default 0;                                       {!!.05}
    property OriginY default 0;                                       {!!.05}
    property ParentColor;
    property ParentShowHint;
    property PictureMask;
    property PopupMenu;
    property ShadowColor default clBtnShadow;                         {!!.05}
    property ShadowedText default False;                              {!!.05}
    property ShowHint;
