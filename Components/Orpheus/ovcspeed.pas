...
type
  ...
  published
    {properties}
    property AutoRepeat default False;                                {!!.05}
    property Flat default False;                                      {!!.05}
    property Glyph;
    property GrayedInactive default True;                             {!!.05}
    property Layout default blGlyphTop;                               {!!.05}
    property Margin default -1;                                       {!!.05}
    property NumGlyphs default 1;                                     {!!.05}
    property RepeatDelay default 500;                                 {!!.05}
    property RepeatInterval default 100;                              {!!.05}
    property Spacing default 1;
    property Style default bsAutoDetect;                              {!!.05}
