{*********************************************************}
{*                    OVCNBK.PAS 4.05                    *}
{*     Copyright 1995-99 (c) TurboPower Software Co      *}
{*                 All rights reserved.                  *}
{*********************************************************}
...
type
  ...
  published
    ...
    property Left stored False;                                        {!!.05}
    property Top stored False;                                         {!!.05}
    property Width stored False;                                       {!!.05}
    property Height stored False;                                      {!!.05}
  end;
  ...
  protected {private}
    ...
    function IsTabHeightStored: Boolean;                               {!!.05}
  ...
  published
    ...
    property Align;
    property Controller;
    property Color default clBtnFace;                                  {!!.05}
    property DragCursor;
    property DragMode;
    property Enabled;
    property Font;
...
begin
  ...
  {TabTabSelecting          := False;} {redundant}                     {!!.05}
  ...
  {FConserveResources      := False;} {redundant}                      {!!.05}
  {FDefaultPageIndex       := 0;} {redundant}                          {!!.05}
  FHighlightColor         := clBtnHighlight;
  {FPageIndex              := 0;} {redundant}                          {!!.05}
  FPageUsesTabColor       := True;
  FShadowColor            := clBtnShadow;
  {FShadowedText           := False;} {redundant}                      {!!.05}
  FTabAutoHeight          := True;
  FTabHeight              := 20;
  {FTabRowcount            := 0;} {redundant}                          {!!.05}
...
function TOvcNotebook.IsTabHeightStored: Boolean;                      {!!.05}
begin
...
var
  ...
  procedure DrawTabBorder({const} TR : TRect; Current : Boolean);     {!!.02}
  var
    PW         : Integer;
    L, T, R, B : Integer;
  begin
  ...
  procedure DrawTab(Index : Integer; const Title : string; IsEnabled,
                    IsTabActive : Boolean;
                    TxtOfs : Integer; {const} Rect, TabRect : TRect); {!!.02}
  var
    HoldColor : TColor;
  begin
...
var
  ...
  procedure DrawTab(Index : Integer; const Title : string; IsEnabled,
                    IsTabActive : Boolean;
                    TxtOfs : Integer; {const} Rect : TRect;           {!!.02}
                    {const} TabRect : TRect);                         {!!.02}
  var
    HoldColor : TColor;
  begin
