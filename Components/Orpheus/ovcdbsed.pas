...
type
  ...
  published
    ...
    {$ENDIF}
    property About;
    property AllowIncDec default False;                               {!!.05}
    property AutoSelect;
    property AutoSize;
    property AutoUpdate default True;                                 {!!.05}
    ...
    property PopupDrawMarks default True;                             {!!.05}
    property PopupHeight default 20;                                  {!!.05}
    property PopupMax;
    property PopupMenu;
    property PopupMin;
    property PopupStep;
    property PopupWidth default 121;                                  {!!.05}
    property ReadOnly default False;                                  {!!.05}
    property ShowButton default True;                                 {!!.05}
    property ShowHint;
    property TabOrder;
    property TabStop;
    property Visible;
