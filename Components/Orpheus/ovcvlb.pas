...
type
  ...
  protected {private}
    ...
    FColumns           : Integer;        {number of char columns}      {!!.02}
    FFillColor         : TColor;
    ...
    procedure SetColumns(const Value: Integer);                        {!!.02}
    ...
    procedure SetScrollBars(const Value : TScrollStyle); virtual;      {!!.02}
  ...
  {.Z-}
    ...
    property Columns : Integer                                         {!!.02}
      read FColumns write SetColumns default vlDefColumns;             {!!.02}
