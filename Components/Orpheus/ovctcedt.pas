...
type
  ...
  TOvcTCString = class(TOvcTCCustomString)
    published
      ...
      property UseWordWrap default False;                             {!!.05}
      property UseASCIIZStrings default False;                        {!!.05}
...
type
  ...
  TOvcTCMemo = class(TOvcTCCustomMemo)
    published
      ...
      property TextHiColor default clBtnHighlight;                    {!!.05}
      property TextStyle default tsFlat;                              {!!.05}
      property WantReturns default False;                             {!!.05}
      property WantTabs default False;                                {!!.05}
