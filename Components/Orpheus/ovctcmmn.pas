...
type
  ...
  TColResizeEvent = procedure ( Sender: TObject; ColNum : TColNum;    {!!.05}
    NewWidth: Integer) of object;                                     {!!.05}
  TRowResizeEvent = procedure ( Sender: TObject; RowNum : TRowNum;    {!!.05}
    NewHeight: Integer) of object;                                    {!!.05}
