...
uses
  Windows, Classes, Controls, Db, DbConsts, DbCtrls, Graphics, Forms,
  Messages, StdCtrls, SysUtils, OvcEdCal, OvcEdPop, OvcEditF;
...
*)                                                                            
  ...
  {Save the key value since calling inherited may set the key to #0}
  {and so the test for NeedsUpdating fails when it shouldn't}
  TheKey := Key;                                                              
