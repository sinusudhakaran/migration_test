...
type
  ...
  published
    ...
    property Controller;
    property ClockFace;
    property ClockMode default cmClock;                               {!!.05}
    property DigitalOptions;
    property DisplayMode default dmAnalog;                            {!!.05}
    property DrawMarks default True;                                  {!!.05}
    property Hint;
    property HandOptions;
    property LabelInfo;
    property MinuteOffset default 0;                                  {!!.05}
    property ParentColor;
    property ParentShowHint;
    property PopupMenu;
    property SecondOffset default 0;                                  {!!.05}
    property ShowHint;
    property TimeOffset default 0;                                    {!!.05}
    property HourOffset default 0;                                    {!!.05}
    property Visible;
    {events}
    property OnClick;
