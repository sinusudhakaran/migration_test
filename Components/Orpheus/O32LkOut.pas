...
type
  ...
  TlobOrientation = (loHorizontal, loVertical);                       {!!.02}
  ...
  protected {private}
    ...
    FActiveItem         : Integer;
    FOrientation        : TLobOrientation;                            {!!.02}
    ...
    property Orientation : TLobOrientation                            {!!.02}
      read FOrientation write SetOrientation;                         {!!.02}
  ...
  public
    ...
    procedure ClampSelectedItemInView;                                {!!.03}
  ...
  published
    ...
    property DrawingStyle default dsDefButton;                         {!!.05}
    property FolderCollection;
    property Images;
    property ItemFont;
    property ItemSpacing;
    property Orientation default loVertical;                           {!!.05}
    property PlaySounds default False;                                 {!!.05}
    property ScrollDelta;
    property SelectedItem default -1;                                  {!!.05}
    property SelectedItemFont;
    property ShowButtons default True;                                 {!!.05}
    property SoundAlias;
    property Storage;
...
{!!.02 - end}
              ...
              if Orientation = loVertical then                        {!!.02}
                with Item.FLabelRect do begin
