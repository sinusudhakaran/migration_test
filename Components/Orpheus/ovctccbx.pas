...
type
  ...
  TOvcTCComboBox = class(TOvcTCCustomComboBox)
    published
      ...
      property AutoAdvanceChar default False;                         {!!.05}
      property AutoAdvanceLeftRight default False;                    {!!.05}
      property Color;
      property DropDownCount default 8;                               {!!.05}
      property Font;
      property HideButton default False;                              {!!.05}
      property Hint;
      property Items;
      property ShowHint default False;                                {!!.05}
      property Margin default 4;                                      {!!.05}
      property MaxLength default 0;                                   {!!.05}
      property SaveStringValue default False;                         {!!.05}
      property ShowArrow default False;                               {!!.05}
      property Sorted default False;                                  {!!.05}
      property Style default csDropDown;                              {!!.05}
      property Table;
      ...
      property UseRunTimeItems default False;                         {!!.05}
