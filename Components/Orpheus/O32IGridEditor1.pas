...
{!!.01}
{8/7/01 - PHB
  - Added a groupbox around the image controls for clarity
  - Adjusted the alignment of some of the controls on the form.
  - Added a popup menu to the TreeView to provide right-click delete
    capabilities.}
...
type
  TIGridCmpEd = class(TForm)
    ...
    SetItem: TEdit;
    ImageBox: TGroupBox;                                              {!!.01}
    Image1: TImage;
    ClearImageBtn: TSpeedButton;
    OvcSpinner1: TOvcSpinner;
    PopupMenu: TPopupMenu;                                            {!!.01}
    Delete1: TMenuItem;                                               {!!.01}
    ...
    procedure ClearImageBtnClick(Sender: TObject);                          {!!.01}
...
function TO32InspectorGridEditor.GetVerb(Index: Integer): AnsiString;
begin
  case Index of
