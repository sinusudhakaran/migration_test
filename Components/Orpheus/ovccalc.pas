...
type
  ...
  published
    ...
    property Enabled;
    property LabelInfo;
    property MaxPaperCount default 9999;                               {!!.05}
    property TapeHeight ; {Must be Prior to Options}
    property Options default [coShowMemoryButtons, coShowItemCount];   {!!.05}
    ...
    property TapeSeparatorChar default '_';                            {!!.05}
    property Visible default True;                                     {!!.05}
