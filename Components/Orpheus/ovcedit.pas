...

{
  ...
  public
    ...
    function GetText(P : PAnsiChar; Size : LongInt) : LongInt;
  ...
  published
    property AutoIndent default False;                                {!!.05}
    property NewStyleIndent default False;                            {!!.05}
    property Borders;
    property BorderStyle default bsSingle;                            {!!.05}
    property ByteLimit default MaxLongInt;                            {!!.05}
    property CaretIns;
    property CaretOvr;
    property FixedFont;
    property HideSelection default True;                              {!!.05}
    property HighlightColors;
    property InsertMode default True;                                 {!!.05}
    property LabelInfo;
    property LeftMargin;
    property MarginColor default clWindow;                            {!!.05}
    property MarginOptions;
    property ParaLengthLimit default High(SmallInt);                  {!!.05}
    property ParaLimit default MaxLongInt;                            {!!.05}
    property ReadOnly default False;                                  {!!.05}
    property RightMargin;
    property RuleColor default clNavy;                                {!!.05}
    property ScrollBars default ssBoth;                               {!!.05}
    property ScrollBarsAlways default False;                          {!!.05}
    property ScrollPastEnd default False;                             {!!.05}
    property ShowBookmarks default True;                              {!!.05}
    property ShowLineNumbers default False;                           {!!.05}
    property ShowRules default False;                                 {!!.05}
    property TabSize default 8;                                       {!!.05}
    property TabType default ttReal;                                  {!!.05}
    property TrimWhiteSpace default True;                             {!!.05}
    property UndoBufferSize default 8*1024;                           {!!.05}
    property WantEnter default True;                                  {!!.05}
    property WantTab default False;                                   {!!.05}
    property WordWrap default False;                                  {!!.05}
    property WrapAtLeft default True;                                 {!!.05}
    property WrapColumn default 80;                                   {!!.05}
    property WrapToWindow default False;                              {!!.05}
    property WheelDelta default 1;                                    {!!.05}
    ...
    property Color;
    property Controller;
    property Cursor default crIBeam;                                  {!!.05}
    property Ctl3D;
    property DragCursor;
    property DragMode;
    property Enabled;
  ...
  published
    property Borders;
    property FileName;
    property IsOpen default False;                                    {!!.05}
    property MakeBackup default False;                                {!!.05}
    property BackupExt stored FMakeBackup;                            {!!.05}
    ...
    property TabType default ttReal;                                  {!!.05}
    property TrimWhiteSpace default True;                             {!!.05}
    property UndoBufferSize default 8192;                             {!!.05}
    property WantEnter default True;                                  {!!.05}
    property WantTab default False;                                   {!!.05}
    property WordWrap default False;                                  {!!.05}
    property WrapAtLeft default True;                                 {!!.05}
...
*)                                                                            
    for I := 0 to StrLen(GPs)-1 do begin                                      
      if (FKeepClipboardChars) then begin                                     
        if not (GPs[I] in FClipboardChars) and                                
               (GPs[I] <= #32) then                                           
          GPs[I] := #32;                                                      
      end else                                                                
        if (GPs[I] < #10) then                                                
...
*)
          for J := 0 to LongInt(StrLen(S2))-1 do begin                        
            if (FKeepClipboardChars) then begin                               
              if not (S2[J] in FClipboardChars) and                           
                     (S2[J] <= #32) then                                      
                S2[J] := #32;                                                 
            end else                                                          
              if (S2[J] < #10) then                                           
