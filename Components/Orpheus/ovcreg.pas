...
begin
  ...
  RegisterPropertyEditor(TypeInfo(TO32Collection), nil, '',           {!!.01}
    TO32CollectionEditor);                                            {!!.01}

  { register collection property editor for the InspectorGrid }
  RegisterPropertyEditor(TypeInfo(TO32Collection), TO32InspectorGrid, {!!.02}
    'ItemCollection', TO32IgridCollectionEditor);                     {!!.02}
