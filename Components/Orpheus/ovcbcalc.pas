{*********************************************************}
{*                   OVCBCALC.PAS 4.05                   *}
{*       COPYRIGHT (C) 1997-2002 TURBOPOWER Software Co  *}
{*                 All rights reserved.                  *}
{*********************************************************}
...
begin
  { Freeing the button glyph throws access violation for some reason }   {!!.05}
  { we'll just let it leak for now. }                                    {!!.05}
//  if FButtonGlyph <> nil then                                          {!!.05}
//    FButtonGlyph.Free;                                                 {!!.05}
  inherited Destroy;
end;
