...
uses
  ...
  StdCtrls, {!!.05 for ssBoth definition}
  Graphics, {!!.05 for color definition}
  Forms; {!!.05 for bsSingle definition}
...
type
  ...
  published
    property AutoUpdate : Boolean
      read FAutoUpdate
      write FAutoUpdate default True;                                 {!!.05}
    ...
    property ByteLimit default 2147483647;                            {!!.05}
    property CaretIns;
    property CaretOvr;
    property FixedFont;
    ...
    property LabelInfo;
    property LeftMargin default 15;                                   {!!.05}
    property MarginColor default clWindow;                            {!!.05}
    property ParaLengthLimit default 32767;                           {!!.05}
    property ParaLimit default 2147483647;                            {!!.05}
    property ReadOnly default False;                                  {!!.05}
    property RightMargin default 5;                                   {!!.05}
