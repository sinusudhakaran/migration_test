...
(*Changes)
{!!.02}
  8/31/01  - Delphi 6's overriding SetItemHeight caused ComboBoxes to be the
            wrong height.  changed to reintroduce.
  10/20/01 - Hdc changed to TOvcHdc for BCB Compatibility.
  10/20/01 - HWnd changed to TOvcHWnd for BCB Compatibility.
  01/15/02 - Added a ForceItemsToMRUList method.
  01/15/02 - Added a MRUList read-only property.
*)
