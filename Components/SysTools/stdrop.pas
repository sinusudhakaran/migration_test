{*********************************************************}
{* SysTools: StDrop.pas 3.03                             *}
{* Copyright (c) TurboPower Software Co 1996, 2001       *}
{* All rights reserved.                                  *}
{*********************************************************}
{* SysTools: Component Wrapper for Shell Drag and Drop   *}
{*********************************************************}
...
begin
  if Assigned(FDropTarget) and                                         {!!.02}
     not FDropTarget.HandleAllocated and not DelayedLoad then begin    {!!.02}
    DelayedLoad := True;                                               {!!.02}
    Exit;                                                              {!!.02}
  end else                                                             {!!.02}
    DelayedLoad := False;                                              {!!.02}
...
begin
  ...
  if not (csDesigning in ComponentState) then begin
    if DelayedLoad then                                                {!!.02}
      SetDropTarget(FDropTarget);                                      {!!.02}
