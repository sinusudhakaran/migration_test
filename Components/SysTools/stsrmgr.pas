{*********************************************************}
{* SysTools: StSrMgr.pas 3.03                            *}
{* Copyright (c) TurboPower Software Co 1996, 2001       *}
{* All rights reserved.                                  *}
{*********************************************************}
{* SysTools: TurboPower string resource runtime manager  *}
{*           SysTools Edition                            *}
{*********************************************************}
...
var
  TpsResStrings : TStStringResource; {error strings for this unit}
...
procedure TStStringResource.ChangeResource(Instance : THandle; const ResourceName : string);
begin
  srCloseResource;
...
constructor TStStringResource.Create(Instance : THandle; const ResourceName : string);
begin
  inherited Create;
...
destructor TStStringResource.Destroy;
begin
  srCloseResource;
  inherited Destroy;
end;
...
function TStStringResource.GetWideChar(Ident : TInt32;
...
function TStStringResource.GetAsciiZ(Ident : TInt32;
...
function TStStringResource.GetString(Ident : TInt32) : string;
var
  P : PIndexRec;
  Src : PWideChar;
  Len, OLen : Integer;
...
procedure TStStringResource.srCloseResource;
begin
...
function TStStringResource.srFindIdent(Ident : TInt32) : PIndexRec;
var
  L, R, M : TInt32;
begin
...
procedure TStStringResource.srLock;
begin
...
procedure TStStringResource.srLoadResource(Instance : THandle; const ResourceName : string);
var
  H : THandle;
...
procedure TStStringResource.srOpenResource(Instance : THandle; const ResourceName : string);
begin
...
procedure TStStringResource.srUnLock;
begin
...
initialization
  TpsResStrings := TStStringResource.Create(HInstance, 'STSRMGR_STRINGS');
