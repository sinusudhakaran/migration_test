{*********************************************************}
{* SysTools: StShBase.pas 3.03                           *}
{* Copyright (c) TurboPower Software Co 1996, 2001       *}
{* All rights reserved.                                  *}
{*********************************************************}
{* SysTools: Base unit for SysTools shell components     *}
{*********************************************************}
...
uses
  Windows, Classes, SysUtils, Dialogs, ShellApi, ShlObj,
...
type
  TStSpecialRootFolder = (sfAltStartup, sfAppData, sfBitBucket, sfCommonAltStartup,
                    ...
                    sfCommonStartMenu, sfCommonStartup, sfConnections, {!!.03}
...
const
  ...
  ShellFolders : array [TStSpecialRootFolder] of Integer =
    (CSIDL_ALTSTARTUP, CSIDL_APPDATA, CSIDL_BITBUCKET, CSIDL_COMMON_ALTSTARTUP,
     ...
     CSIDL_COMMON_STARTMENU, CSIDL_COMMON_STARTUP, CSIDL_Connections, {!!.03}
