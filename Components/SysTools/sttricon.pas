{*********************************************************}
{* SysTools: StTrIcon.pas 3.03                           *}
{* Copyright (c) TurboPower Software Co 1996, 2001       *}
{* All rights reserved.                                  *}
{*********************************************************}
{* SysTools: Component to put Application in "Tray"      *}
{*********************************************************}
...
{$Z-}
    ...
    procedure MinimizeApplication;                                     {!!.02}
...
procedure TStCustomTrayIcon.MinimizeApplication;                       {!!.02}
begin
