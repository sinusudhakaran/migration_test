...
type
  ...
  {$IFNDEF VERSION3}                                           {!!.02}
  TStSetStreamSize = procedure(aStream  : TStream;             {!!.02}
                               aNewSize : longint) of object;  {!!.02}
  {$ENDIF}                                                     {!!.02}
  ...
  TStBufferedStream = class(TStream)
    private
      ...
      {$IFNDEF VERSION3}
      FOnSetStreamSize : TStSetStreamSize;                     {!!.02}
    ...
    protected
      ...
      {$IFDEF VERSION3}                                        {!!.02}
      procedure SetSize(NewSize : longint); override;          {!!.02}
      {$ENDIF}                                                 {!!.02}
    public
      ...
      {$IFNDEF VERSION3}                                       {!!.02}
      procedure SetSize(NewSize : longint);                    {!!.02}
      {$ENDIF}                                                 {!!.02}
      ...
      {$IFNDEF VERSION3}                                       {!!.02}
      property OnSetStreamSize : TStSetStreamSize              {!!.02}
                 read FOnSetStreamSize write FOnSetStreamSize; {!!.02}
      {$ENDIF}                                                 {!!.02}
   end;
...
procedure TStBufferedStream.SetSize(NewSize : longint);    {new !!.02}
var
  NewPos : longint;
begin
  ...
  if not Assigned(FOnSetStreamSize) then
    RaiseStError(EStBufStreamError, stscCannotSetSize);
