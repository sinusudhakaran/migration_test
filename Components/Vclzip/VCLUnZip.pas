...
const
   kpThisVersion         = 304; {added this constant 3/1/98 for version 2.03}
   kpThisBuild           = 1;
   {$IFNDEF ZLIB121}
    ZLIB_VERSION         = '1.1.4';
   {$ELSE}
...
{$L trees.obj}
{$L adler32.obj}
{$ELSE}                   // ZLIB_VERSION SHOULD BE 1.2.1
{$L zlib121\adler32.obj}
{$L zlib121\compress.obj}
{$L zlib121\crc32.obj}
{$L zlib121\deflate.obj}
{$L zlib121\infback.obj}
{$L zlib121\inffast.obj}
{$L zlib121\inflate.obj}
{$L zlib121\inftrees.obj}
{$L zlib121\trees.obj}
{$L zlib121\zutil.obj}
