...
Type
  TUKDisk_Header_Rec  = Packed Record { 128 Bytes }
  ...
  PUKDirectory_Rec = ^TUKDirectory_Rec;
  TUKDirectory_Rec = Packed Record { 128 bytes }
  ...
  PUKEntry_Rec = ^TUKEntry_Rec;
  TUKEntry_Rec = Packed Record { 80 Bytes }
    dDate             : LongInt; { 4 }
    dType             : Byte;
...
Type
  TUKEntry_Sector = Packed Record
    Slot  : Array[ 1..6  ] of TUKEntry_Rec;
...
Type
  ...
  PUKDiskImage = ^TUKDiskImage;
  TUKDiskImage = Packed Record  // 1440 TSector
    RT86Directory : Array[ 0..13 ] of TSector;
    Header        : TUKDisk_Header_Rec;
    Directory     : Array[ 1..255 ] of TUKDirectory_Rec;
    SystemMsg     : Array[ 0..7 ] of TSector; // Unused
    ClientMsg     : Array[ 0..7 ] of TSector; // Unused
    Entries       : Array[ 1..1346 ] of TUKEntry_Sector;
  end;

//------------------------------------------------------------------------------

  UKDiskIDRec = Packed Record  // Written at start of Compressed Data Disk Image.  Not Compressed.
